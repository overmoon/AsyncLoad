...
public class Utils {
    ...
    // generate the string, which is used to generate the key
    // eg. file://xxxxxx.xxx_36x36
    public static String generateKeyString(String uri, ImageSize imageSize) {
        return new StringBuffer().append(uri).append(BitmapUtils.URI_AND_SIZE_SEPARATOR).append(imageSize.toString()).toString();
    }
    ...
    public static String generateKeyByHash(String uri) {
        return generateKeyByHash(uri, new ImageSize());
    }
